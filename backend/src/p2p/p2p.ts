...
import { asserts, getOpt, hasOpt, jsonReplacer, jsonReviver, now } from '@backend/helpers/utils';
...
import type { BlockData, BlockHash, BlockReceipt } from '@backend/types/block.types';
import { TransactionData } from '@backend/types/transaction.types';
import { initialPeers } from '@backend/config';
